  ...
  properties (TestParameter)
    validInput = struct( ...
      ...
      , 'redefinedKey_CorrectNested', {{ ...
        ...
        'string_escapedEscape', {{
          'key = "\e["', ...
          containers.Map('key', [char(27) '['], 'UniformValues', false), ...
          'Did not parse a basic string with \e escape successfully.' ...
                   }}, ...
        'string_escapedHex', {{
          'key = "\x61"', ...
          containers.Map('key', 'a', 'UniformValues', false), ...
          'Did not parse a basic string with \xHH escape successfully.' ...
                   }}, ...
        'string_escapedHexNull', {{
          'key = "\x00"', ...
          containers.Map('key', char(0), 'UniformValues', false), ...
          'Did not parse a basic string with \x00 escape successfully.' ...
                   }}, ...
        'time_withoutSeconds', {{
          'odt = 14:15', ...
          containers.Map('odt', '14:15', 'UniformValues', false), ...
          'Did not parse a local time without seconds successfully.' ...
                   }}, ...
        'dateTime_withoutSeconds', {{
          'dt = 2010-02-03 14:15', ...
          containers.Map('dt', '2010-02-03T14:15', 'UniformValues', false), ...
          'Did not parse a local datetime without seconds successfully.' ...
                   }}, ...
        'inlineTable_multiline', {{
          sprintf('tbl = {\n    key = "a",\n    b = 1,\n}'), ...
          containers.Map('tbl', containers.Map({'key', 'b'}, {'a', int64(1)})), ...
          'Did not parse a multiline inline table successfully.' ...
                   }}, ...
        'inlineTable_trailingComma', {{
          'tbl = {first = "John", last = "Doe",}', ...
          containers.Map('tbl', containers.Map({'first', 'last'}, {'John', 'Doe'}, 'UniformValues', false)), ...
          'Did not parse an inline table with trailing comma successfully.' ...
                   }} ...
        );
